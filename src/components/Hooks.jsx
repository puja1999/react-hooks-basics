...
const Hooks = () => {
  ...
  const changeColor = () => {
    //this function is to set color that we used in context
  ...
  return (
    <div className="main">
      <div className="section1">
        ...
        <h3>
          {" "}
          Today I am <strong style={{ color: "red" }}>{age}</strong> Years of
          Age{" "}
        </h3>
        <div>
      ...
      <div className="section2">
        ...
        <h3>
          {" "}
          Today I am <strong style={{ color: "red" }}>{age1}</strong> Years of
          Age{" "}
        </h3>
        <h3>
          I have <strong style={{ color: "red" }}>{siblingsNum}</strong>{" "}
          siblings{" "}
        </h3>
        <div>
      ...
      <div className="section3">
        ...
        <h3>
          {" "}
          Today I am <strong style={{ color: "red" }}>{age2}</strong> Years of
          Age{" "}
        </h3>
        <h3>
          I have <strong style={{ color: "red" }}>{siblingsNum1}</strong>{" "}
          siblings{" "}
        </h3>
        <div>
          <button onClick={handleClick.bind(null, "age2")}>Get older!</button>
          <button onClick={handleClick.bind(null, "siblingsNum1")}>
            More siblings!
          </button>
        </div>
      </div>
      ...
      <div className="section4">
        ...
        <h3>
          {" "}
          Count value is: <strong style={{ color: "red" }}>{count}</strong>
        </h3>
        <div>
          <button onClick={() => setCount(0)}>Reset</button>
          <button onClick={() => setCount((nextCount) => nextCount - 1)}>
            Minus (-)
          </button>
